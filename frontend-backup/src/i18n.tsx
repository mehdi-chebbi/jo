...
'askQuestion.error.empty': 'Question cannot be empty',
  ...
  'home.section.subtitle': "Help us build a resilient and sustainable future for Africa.",
  ...
  'filters.status.actif': 'Active',
  'filters.status.sousEvaluation': 'Under Review',
  'filters.status.resultat': 'Result',
  'filters.status.infructueux': 'Unsuccessful',
  'filters.status.cloture': 'Closed',

  'filters.scope': 'Scope',
  'filters.scope.all': 'All',
  'filters.scope.national': 'National',
  'filters.scope.international': 'International',
...
"rh.infructueuxInfo": "This offer did not result in a hire",
...
"rh.infructueuxDisplay.label" : "Unsuccessful Offer",// Swal alert translations
  ...
  'about.p2': 'As of today, the OSS has 28 African member states and 7 non-African member states. Furthermore, the Organization works with 13 partner entities, including African regional organizations, UN agencies, and non-governmental organizations.',
  ...
  'rh.status.actif': 'Active',
  'rh.status.sousEvaluation': 'Under Review',
  'rh.status.resultat': 'Result',
  'rh.status.infructueux': 'Unsuccessful',
  'rh.status.cloture': 'Closed',
  ...
  'rh.form.generateReference': 'Generate',
  'rh.form.generateReferenceTitle': 'Missing fields',
  'rh.form.generateReferenceText': 'Please select method, project and fill the title before generating the reference.',
  ...
  'rh.form.customDocuments.nameFr': 'Document name (French)',
  'rh.form.customDocuments.nameEn': 'Document name (English)',
  'rh.form.customDocuments.placeholderFr': 'Enter the French document name...',
  'rh.form.customDocuments.placeholderEn': 'Enter the English document name...',
  ...
  'rh.button.revertWinner': 'Revert Winner',
  'rh.button.revertInfructueux': 'Revert Infructueux',
  'rh.button.reverting': 'Reverting...',
  'rh.swal.revertWinnerTitle': 'Revert Winner Selection',
  'rh.swal.revertWinnerConfirmation': 'Are you sure you want to revert the winner selection for "{offerTitle}"? The selected candidate "{winner}" will be removed and the offer will return to "Under Review" status.',
  'rh.swal.revertWinnerConfirm': 'Yes, revert winner',
  'rh.swal.revertWinnerCancel': 'Cancel',
  'rh.swal.revertWinnerCompleteTitle': 'Winner Reverted',
  'rh.swal.revertWinnerCompleteText': 'The winner has been removed. The offer is now back to "Under Review".',
  'rh.swal.revertWinnerFailedTitle': 'Revert Failed',
  'rh.swal.revertInfructueuxTitle': 'Revert Infructueux Status',
  'rh.swal.revertInfructueuxConfirmation': 'Are you sure you want to revert the infructueux status for "{offerTitle}"? The offer will return to "Under Review" status.',
  'rh.swal.revertInfructueuxConfirm': 'Yes, revert infructueux',
  'rh.swal.revertInfructueuxCancel': 'Cancel',
  'rh.swal.revertInfructueuxCompleteTitle': 'Infructueux Reverted',
  'rh.swal.revertInfructueuxCompleteText': 'The offer is now back to "Under Review".',
  'rh.swal.revertInfructueuxFailedTitle': 'Revert Failed',
  'rh.swal.archiveWarning': 'Note: Any previously archived applications will remain archived as historical records.',
  'rh.button.edit': 'Edit',
  ...
  // Offer details popup (clickable title)
  'rh.offerDetails.title': 'Offer Details',
  'rh.offerDetails.loading': 'Loading offer details...',
  'rh.offerDetails.error': 'Failed to load offer details',
  'rh.offerDetails.reference': 'Reference',
  'rh.offerDetails.type': 'Type',
  'rh.offerDetails.method': 'Method',
  'rh.offerDetails.country': 'Country',
  'rh.offerDetails.department': 'Department',
  'rh.offerDetails.project': 'Project',
  'rh.offerDetails.deadline': 'Deadline',
  'rh.offerDetails.status': 'Status',
  'rh.offerDetails.applications': 'Applications',
  'rh.offerDetails.applicationsCount': '{count} candidate(s)',
  'rh.offerDetails.winner': 'Selected Candidate',
  'rh.offerDetails.noWinner': 'Not yet selected',
  'rh.offerDetails.description': 'Description',
  'rh.offerDetails.noDescription': 'No description available',
  'rh.offerDetails.createdOn': 'Created on',
  'rh.offerDetails.requestedDocuments': 'Requested Documents',
  'rh.offerDetails.noRequestedDocuments': 'No documents requested',
  'rh.offerDetails.required': 'Required',
  'rh.offerDetails.optional': 'Optional',
  'rh.offerDetails.tdr': 'Terms of Reference (TDR)',
  'rh.offerDetails.tdrFr': 'TDR (French)',
  'rh.offerDetails.tdrEn': 'TDR (English)',
  'rh.offerDetails.tdrNotAvailable': 'No TDR available',
  'rh.offerDetails.viewDetails': 'Click to view details',
  'rh.offerDetails.close': 'Close',

  // Deadline display (always show date + status)
  'rh.deadlineExpired': 'Expired',
  'rh.deadlineToday': 'Today',
  'rh.deadlineDaysLeft': 'In {days} days',
...
'profile.title': 'My Profile',
  'profile.subtitle': 'View and update your account information',
  ...
  'profile.cannotEdit': 'This field cannot be modified',
  'profile.passwordMinLength': 'Minimum 6 characters',
  'profile.success': 'Password Updated!',
  'profile.successMessage': 'Your password has been changed successfully.',
  'profile.error.fetch': 'Failed to fetch profile',
  'profile.error.update': 'Failed to update password',
  'profile.error.generic': 'An error occurred. Please try again.',
  'profile.validation.allFields': 'Please fill in all password fields',
  'profile.validation.passwordsMatch': 'New passwords do not match',
  ...
  'app.change_filter': 'Try adjusting your filter criteria or check back later for new opportunities.',
  'app.delete_filters': 'Clear Filters',
'home.allcategory': 'All Categories',


};

const fr: Translations = {
  'home.allcategory': 'Toutes les catégories',
  'app.delete_filters': 'Effacer les filtres',
  'app.change_filter': 'Essayez de modifier vos critères de filtrage ou revenez ultérieurement pour voir les nouvelles opportunités.',
  'app.no_offers_found': 'Aucune opportunité ne correspond à vos filtres',
    'app.brand.logan': 'Connecter les talents aux opportunités à travers l\'Afrique.',
    'home.category': 'Catégorie',

  'app.brand.title': 'OSS Opportunités',
  ...
  'home.section.subtitle': "Aidez-nous à construire un avenir résilient et durable pour l'Afrique.",
...
'askQuestion.error.empty': 'Question ne peut pas etre vide',
  ...
  'about.p2': "Aujourd'hui, l'OSS compte 28 pays africains et 7 pays non africains membres. Par ailleurs, l'Organisation collabore avec 13 entités organisations régionales représentatives de l'Afrique, des agences onusiennes et des organisations non gouvernementales.",
...
"rh.infructueuxDisplay.label" : "Offre infructueuse",// Swal alert translations
  ...
  'rh.form.generateReference': 'Générer',
  'rh.form.generateReferenceTitle': 'Champs manquants',
  'rh.form.generateReferenceText': 'Veuillez sélectionner la méthode, le projet et remplir le titre avant de générer la référence.',
  'rh.form.description': 'Description',
  ...
  'rh.form.customDocuments.nameFr': 'Nom du document (Français)',
  'rh.form.customDocuments.nameEn': 'Nom du document (Anglais)',
  'rh.form.customDocuments.placeholderFr': 'Entrez le nom français du document...',
  'rh.form.customDocuments.placeholderEn': 'Entrez le nom anglais du document...',
  ...
  'rh.button.revertWinner': 'Annuler la Sélection',
  'rh.button.revertInfructueux': 'Annuler Infructueux',
  'rh.button.reverting': 'Annulation...',
  'rh.swal.revertWinnerTitle': 'Annuler la Sélection du Candidat',
  'rh.swal.revertWinnerConfirmation': 'Êtes-vous sûr de vouloir annuler la sélection du candidat pour "{offerTitle}" ? Le candidat sélectionné "{winner}" sera retiré et l\'offre reviendra au statut "Sous Évaluation".',
  'rh.swal.revertWinnerConfirm': 'Oui, annuler la sélection',
  'rh.swal.revertWinnerCancel': 'Annuler',
  'rh.swal.revertWinnerCompleteTitle': 'Sélection Annulée',
  'rh.swal.revertWinnerCompleteText': 'Le candidat a été retiré. L\'offre est revenue au statut "Sous Évaluation".',
  'rh.swal.revertWinnerFailedTitle': 'Échec de l\'Annulation',
  'rh.swal.revertInfructueuxTitle': 'Annuler le Statut Infructueux',
  'rh.swal.revertInfructueuxConfirmation': 'Êtes-vous sûr de vouloir annuler le statut infructueux pour "{offerTitle}" ? L\'offre reviendra au statut "Sous Évaluation".',
  'rh.swal.revertInfructueuxConfirm': 'Oui, annuler infructueux',
  'rh.swal.revertInfructueuxCancel': 'Annuler',
  'rh.swal.revertInfructueuxCompleteTitle': 'Infructueux Annulé',
  'rh.swal.revertInfructueuxCompleteText': 'L\'offre est revenue au statut "Sous Évaluation".',
  'rh.swal.revertInfructueuxFailedTitle': 'Échec de l\'Annulation',
  'rh.swal.archiveWarning': 'Remarque : Les candidatures précédemment archivées resteront archivées en tant qu\'enregistrements historiques.',
  ...
  'rh.button.cancel': 'Annuler',
    ...
    'askQuestion.submitting': 'Envoi en cours...',
'askQuestion.disabledNotice' : 'Les questions ne peuvent être soumises que lorsqu’il reste plus de 10 jours.',
  ...
  // Popup détails de l'offre (titre cliquable)
  'rh.offerDetails.title': 'Détails de l\'Offre',
  'rh.offerDetails.loading': 'Chargement des détails de l\'offre...',
  'rh.offerDetails.error': 'Échec du chargement des détails',
  'rh.offerDetails.reference': 'Référence',
  'rh.offerDetails.type': 'Type',
  'rh.offerDetails.method': 'Méthode',
  'rh.offerDetails.country': 'Pays',
  'rh.offerDetails.department': 'Département',
  'rh.offerDetails.project': 'Projet',
  'rh.offerDetails.deadline': 'Date limite',
  'rh.offerDetails.status': 'Statut',
  'rh.offerDetails.applications': 'Candidatures',
  'rh.offerDetails.applicationsCount': '{count} candidat(s)',
  'rh.offerDetails.winner': 'Candidat Sélectionné',
  'rh.offerDetails.noWinner': 'Pas encore sélectionné',
  'rh.offerDetails.description': 'Description',
  'rh.offerDetails.noDescription': 'Aucune description disponible',
  'rh.offerDetails.createdOn': 'Créé le',
  'rh.offerDetails.requestedDocuments': 'Documents demandés',
  'rh.offerDetails.noRequestedDocuments': 'Aucun document demandé',
  'rh.offerDetails.required': 'Obligatoire',
  'rh.offerDetails.optional': 'Optionnel',
  'rh.offerDetails.tdr': 'Termes de Référence (TDR)',
  'rh.offerDetails.tdrFr': 'TDR (Français)',
  'rh.offerDetails.tdrEn': 'TDR (Anglais)',
  'rh.offerDetails.tdrNotAvailable': 'Aucun TDR disponible',
  'rh.offerDetails.viewDetails': 'Cliquez pour voir les détails',
  'rh.offerDetails.close': 'Fermer',

  // Affichage de la date limite (toujours afficher la date + statut)
  'rh.deadlineExpired': 'Expiré',
  'rh.deadlineToday': 'Aujourd\'hui',
  'rh.deadlineDaysLeft': 'Dans {days} jours',
  ...
  'profile.subtitle': 'Voir et mettre à jour vos informations de compte',
  ...
  'profile.cannotEdit': 'Ce champ ne peut pas être modifié',
  'profile.passwordMinLength': 'Minimum 6 caractères',
  'profile.success': 'Mot de Passe Mis à Jour!',
  'profile.successMessage': 'Votre mot de passe a été modifié avec succès.',
  'profile.error.fetch': 'Échec de la récupération du profil',
  'profile.error.update': 'Échec de la mise à jour du mot de passe',
  'profile.error.generic': 'Une erreur est survenue. Veuillez réessayer.',
  'profile.validation.allFields': 'Veuillez remplir tous les champs de mot de passe',
  'profile.validation.passwordsMatch': 'Les nouveaux mots de passe ne correspondent pas',
  'profile.validation.passwordLength': 'Le mot de passe doit contenir au moins 6 caractères',
};
