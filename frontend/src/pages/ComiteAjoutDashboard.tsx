...
const ComiteAjoutDashboard = () => {
  ...
  const fetchOffers = useCallback(async () => {
    try {
      // Fetch offers with application counts using /applications/summary endpoint
      ...
      // Transform OfferSummary to Offer format for OffersSection
      const transformedOffers: Offer[] = data.map(summary => ({
        id: summary.offer_id,
        type: summary.offer_type as any,
        method: 'entente_directe' as any, // Default value, not used in display
        title: summary.offer_title,
        description: '', // Not provided by summary endpoint
        country: '', // Not provided by summary endpoint
        project_id: 0, // Not provided by summary endpoint
        project_name: summary.offer_project,
        department_name: summary.offer_department,
        reference: '', // Not provided by summary endpoint
        deadline: summary.deadline,
        created_at: '', // Not provided by summary endpoint
        tdr_filename: null,
        tdr_url: null,
        notification_emails: undefined,
        custom_required_documents: undefined,
        status: summary.status,
        winner_name: summary.winner_name,
        days_since_expiry: undefined,
        can_archive: undefined,
        // Add application_count to the Offer object
